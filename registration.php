...
<header class="header">
   ...
   <div class="icons">
      <nav class="navbar">
         <a href="#blogs"><?php echo $_SESSION['name']; ?></a>
      </nav>
      <a href="logout.php"><div class="fas fa-user"></div></a>
...
<section class="footer">
   ...
   <div class="credit"> created by <span>Abhijit Singh</span> | all rights reserved! </div>
